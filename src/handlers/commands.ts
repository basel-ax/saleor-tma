...
class CommandHandlers {
  static async handleStart(message: TelegramMessage): Promise<void> {
  ...
  static async handleTest(message: TelegramMessage): Promise<void> {
    const chatId = message.chat.id;
    await telegramService.sendMessage(
      chatId,
  ...
  static async handleHelp(message: TelegramMessage): Promise<void> {
    const chatId = message.chat.id;
    await telegramService.sendMessage(
      chatId,
  ...
  static async handlePing(message: TelegramMessage): Promise<void> {
    const chatId = message.chat.id;
